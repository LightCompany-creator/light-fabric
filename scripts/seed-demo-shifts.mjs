...
const PLAN = [
  // ============ Литейный цех ============
  {
    ...
    workers: [
      // tab, [{ article_code, operation, qty }]
      { tab: "0034", ops: [{ code: "022/1", op: "литьё", qty: 180 }, { code: "905", op: "литьё", qty: 60 }] },
      { tab: "0045", ops: [{ code: "007", op: "литьё", qty: 240 }] },
      { tab: "0065", ops: [{ code: "905", op: "литьё", qty: 60 }] },
    ],
  },
  {
    daysBack: 11,
    ...
    workers: [
      { tab: "0067", ops: [{ code: "112/н", op: "литьё", qty: 80 }] },
      { tab: "0035", ops: [{ code: "184/н", op: "литьё", qty: 60 }] },
    ],
  },
  {
    daysBack: 9,
    ...
    workers: [
      { tab: "0034", ops: [{ code: "022/1", op: "литьё", qty: 150 }] },
      { tab: "0065", ops: [{ code: "907", op: "литьё", qty: 100 }] },
    ],
  },
  {
    daysBack: 6,
    ...
    workers: [
      { tab: "0045", ops: [{ code: "007", op: "литьё", qty: 300 }] },
      { tab: "0067", ops: [{ code: "1027", op: "литьё", qty: 80 }] },
    ],
  },
  {
    daysBack: 3,
    ...
    workers: [
      { tab: "0035", ops: [{ code: "112/н", op: "литьё", qty: 70 }] },
      { tab: "0034", ops: [{ code: "022/1", op: "литьё", qty: 200 }] },
      { tab: "0065", ops: [{ code: "905", op: "литьё", qty: 100 }] },
    ],
  },
  ...
  // ============ Упаковка ============
  {
    ...
    type: "день",
    workshop: "PACK",
    foremanTab: "0021", // Мангасарян — начцеха
    outputs: [
      { code: "022/1", qty: 180, defect: 1 },
      { code: "007", qty: 240, defect: 2 },
    ],
    workers: [
      { tab: "0032", ops: [{ code: "022/1", op: "обрезка", qty: 180 }] },
      { tab: "0039", ops: [{ code: "007", op: "обрезка", qty: 240 }] },
      { tab: "0056", ops: [{ code: "007", op: "упаковка без носка", qty: 240 }] },
      { tab: "0058", ops: [{ code: "022/1", op: "упаковка без носка", qty: 180 }] },
    ],
  },
  {
    daysBack: 8,
    ...
    workers: [
      { tab: "0032", ops: [{ code: "112/н", op: "обрезка", qty: 80 }, { code: "184/н", op: "обрезка", qty: 60 }] },
      { tab: "0063", ops: [{ code: "112/н", op: "упаковка с носком", qty: 80 }] },
      { tab: "0074", ops: [{ code: "184/н", op: "упаковка с носком", qty: 60 }] },
    ],
  },
  {
    daysBack: 5,
    ...
    workers: [
      { tab: "0032", ops: [{ code: "022/1", op: "обрезка", qty: 150 }] },
      { tab: "0039", ops: [{ code: "907", op: "обрезка", qty: 100 }] },
    ],
  },
  ...
  // ============ Клеевой ============
  {
    ...
    workers: [
      { tab: "0026", ops: [{ code: "112/н", op: "клеёжка", qty: 80 }] },
      { tab: "0048", ops: [{ code: "184/н", op: "клеёжка", qty: 60 }] },
      { tab: "0057", ops: [{ code: null, op: "вставка", qty: 140 }] },
    ],
  },
  ...
  // ============ Обшив ============
  {
    ...
    workers: [
      { tab: "0061", ops: [{ code: "112/н", op: "обшив", qty: 70 }, { code: "184/н", op: "обшив", qty: 50 }] },
    ],
  },
  ...
  // ============ Маркировка ============
  {
    ...
    workers: [
      { tab: "0027", ops: [{ code: "022/1", op: "маркировка", qty: 180 }] },
      { tab: "0036", ops: [{ code: "007", op: "маркировка", qty: 240 }] },
      { tab: "0041", ops: [{ code: "905", op: "маркировка", qty: 120 }] },
    ],
  },
];
