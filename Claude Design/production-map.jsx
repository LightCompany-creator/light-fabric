// LightFlow — Production Map (Карта производства · диспетчерская)
...
const WS = [
  { id: 'raw',  name: 'Сырьё',       hue: '#64748B', icon: 'cube',    role: 'stock' },
  { id: 'mold', name: 'Литейка',     hue: '#EF4444', icon: 'flame',   role: 'work',
    load: 92, batches: 6, queue: 4, foreman: 'Сидоров К.А.', people: 4,
    list: [
      { id: 'ЛИТ-120526-01', sku: '112/н Сапоги',  qty: 96,  status: 'work' },
      { id: 'ЛИТ-120526-02', sku: '905 Галоши',    qty: 144, status: 'work' },
      { id: 'ЛИТ-120526-03', sku: '022 Сабо',      qty: 72,  status: 'work' },
      { id: 'ЛИТ-120526-04', sku: '441 Ботинки',   qty: 60,  status: 'queue' },
    ] },
  { id: 'pack', name: 'Упаковка',    hue: '#214A8C', icon: 'box',     role: 'dispatcher',
    load: 78, batches: 9, queue: 7, foreman: 'Захарова О.Л.', people: 6,
    list: [
      { id: 'УПК-120526-01', sku: '112/н Сапоги',  qty: 96,  status: 'work', dest: 'Маркировка' },
      { id: 'УПК-120526-02', sku: '905 Галоши',    qty: 144, status: 'work', dest: 'Маркировка' },
      { id: 'УПК-120526-03', sku: '022 Сабо',      qty: 72,  status: 'work', dest: 'Клеевой' },
      { id: 'УПК-120526-04', sku: '441 Ботинки',   qty: 60,  status: 'work', dest: 'Крой' },
    ] },
  { id: 'mark', name: 'Маркировка',  hue: '#06B6D4', icon: 'tag',     role: 'work',
    load: 64, batches: 4, queue: 2, foreman: 'Соколова Е.П.', people: 3 },
  { id: 'glue', name: 'Клеевой',     hue: '#F59E0B', icon: 'drop',    role: 'work',
    load: 88, batches: 5, queue: 5, foreman: 'Волков С.Е.', people: 5, warn: true },
  { id: 'cut',  name: 'Крой',        hue: '#EC4899', icon: 'scissors',role: 'work',
    load: 55, batches: 3, queue: 1, foreman: 'Новиков Р.С.', people: 4 },
  { id: 'sew',  name: 'Швейка',      hue: '#8B5CF6', icon: 'needle',  role: 'work',
    load: 71, batches: 4, queue: 3, foreman: 'Морозова Н.В.', people: 6 },
  { id: 'hem',  name: 'Обшив',       hue: '#10B981', icon: 'thread',  role: 'work',
    load: 48, batches: 3, queue: 0, foreman: 'Орлова И.К.', people: 3 },
  { id: 'wh',   name: 'Склад',       hue: '#3B82F6', icon: 'wh',      role: 'sink',
    load: 35, batches: 12, queue: 0, foreman: 'Григорьев А.В.', people: 2 },
];
  ...
  return (
    <aside style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, paddingBottom: 12, borderBottom: `1px solid ${theme.borderSoft}` }}>
        ...
        <div>
          <div style={{ fontSize: 14, fontWeight: 800, color: theme.ink, letterSpacing: '-0.01em' }}>LightFlow</div>
...
// ====== EVENT FEED ======
const EVENTS = [
  { t: '16:42', txt: 'ЛИТ-120526-01 принята в Клеевом',  who: 'Волков С.Е.',      tag: 'accept',  ws: 'glue' },
  { t: '16:38', txt: 'УПК-120526-04 передана в Крой',     who: 'Захарова О.Л.',    tag: 'move',    ws: 'pack' },
  { t: '16:30', txt: 'Закрыта смена в Швейке',            who: 'Морозова Н.В. · 24 операции', tag: 'shift-close', ws: 'sew' },
  { t: '16:22', txt: 'Зафиксирован брак: 2 пары 905',     who: 'ОТК · отбор',      tag: 'defect', ws: 'mark', warn: true },
  { t: '16:15', txt: 'ЛИТ-120526-02 завершена',           who: 'Сидоров К.А.',     tag: 'finish', ws: 'mold' },
  { t: '16:08', txt: 'Маркировка: КРС-1 простой 8 мин',   who: 'Соколова Е.П.',    tag: 'idle',   ws: 'mark', warn: true },
  { t: '15:54', txt: 'УПК-120526-03 → Маркировка',        who: 'Захарова О.Л.',    tag: 'move',    ws: 'pack' },
  { t: '15:42', txt: 'Списано ЭВА 124.8 кг',              who: 'Литейка · норматив', tag: 'stock', ws: 'mold' },
  { t: '15:30', txt: 'Принят склад: 96 пар 112/н',        who: 'Григорьев А.В.',   tag: 'wh-in',   ws: 'wh' },
  { t: '15:18', txt: 'СБК-120526-02 передана в Склад',    who: 'Орлова И.К.',      tag: 'move',    ws: 'hem' },
];
const TAG_LABELS = {
  accept: 'Принято',
  move: 'Передача',
    ...
    <header style={{
      ...
      <div>
        ...
        <div style={{ fontFamily: PM.mono, fontSize: 10, color: theme.dim, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
          ООО «Светлая компания» · диспетчерская
        </div>
      </div>
      ...
      <div style={{ paddingLeft: 16, borderLeft: `1px solid ${theme.borderSoft}`, display: 'flex', alignItems: 'center', gap: 10 }}>
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: theme.ink }}>А. Воронцов</div>
          <div style={{ fontFamily: PM.mono, fontSize: 10, color: theme.dim }}>Директор</div>
        </div>
        <div style={{
